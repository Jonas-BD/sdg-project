...
export const MainPage = () => {
  return (
    <section>
      <ContentWrapper title="VERDENSMÅLENE" showTitle={true}>
        <Container color="#ffffff" width="100%">
          <Container padding="0.5rem 5rem">
            <article>
              <h2>Hvad er FN's Verdensmål for bæredygtig udvikling?</h2>
              <h3>FN's Verdensmål består af 17 mål og 169 delmål og er den til dato mest ambitiøse globale udviklingsdagsorden</h3>
